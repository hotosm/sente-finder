...
public class BorrowMoneyFSPFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        applicationPreference = new ApplicationPreference(getContext(), TAG_BORROW_MONEY);
...
//                fragmentService.deflateAllFspMarkers();
    ...
    public void getBorrowFinancialServiceProviders() {
        ...
        call.enqueue(new Callback<List<FinancialServiceProvider>>() {
            ...
            public void onResponse(Call<List<FinancialServiceProvider>> call, Response<List<FinancialServiceProvider>> response) {
                ...
                if (response.body() != null) {
                    try {
                        InternalStorageService.writeCacheToFile(getContext(), TAG_BORROW_MONEY, response.body());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
