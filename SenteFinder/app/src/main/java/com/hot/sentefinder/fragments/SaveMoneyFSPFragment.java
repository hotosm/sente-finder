...
public class SaveMoneyFSPFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        applicationPreference = new ApplicationPreference(getContext(), TAG_SAVE_MONEY);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(applicationPreference.readFirstLoadPreference()){
            ...
            List<FinancialServiceProvider> cachedFSPs = fragmentService.getFinancialServiceProvidersFromCache(TAG_SAVE_MONEY);
    ...
    public void getSaveFinancialServiceProviders() {
        swipeRefreshLayout.setRefreshing(true);

        APIClientInterface retrofitClient = RetrofitClient.getClient().create(APIClientInterface.class);

        Call<List<FinancialServiceProvider>> call = retrofitClient.getSaveFinancialServiceProviders(searchParam);
...
//                        InternalStorageService.writeObject(getContext(), KEY, response.body());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else {
