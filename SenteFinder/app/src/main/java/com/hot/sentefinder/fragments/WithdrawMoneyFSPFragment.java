...
public class WithdrawMoneyFSPFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        applicationPreference = new ApplicationPreference(getContext(), TAG_WITHDRAW_MONEY);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(applicationPreference.readFirstLoadPreference()){
            ...
            List<FinancialServiceProvider> cachedFSPs = fragmentService.getFinancialServiceProvidersFromCache(TAG_WITHDRAW_MONEY);
            ...
            if(cachedFSPs.isEmpty()){
                ...
                if(searchResultsList != null && (fragment != null && fragment.equals(TAG_WITHDRAW_MONEY))){
                    ...
                    if(searchResultsList.size() > 0){
                        ...
                        new GetProvidersTask(TAG_WITHDRAW_MONEY, getContext(), getActivity(), financialServiceProviderList, FSPList, financialServiceProviderAdapter).execute();
    ...
    public void getWithdrawFinancialServiceProviders() {
        swipeRefreshLayout.setRefreshing(true);

        APIClientInterface retrofitClient = RetrofitClient.getClient().create(APIClientInterface.class);

        Call<List<FinancialServiceProvider>> call = retrofitClient.getWithdrawFinancialServiceProviders(searchParam);
        call.enqueue(new Callback<List<FinancialServiceProvider>>() {
            ...
            public void onResponse(Call<List<FinancialServiceProvider>> call, Response<List<FinancialServiceProvider>> response) {
                ...
                if (response.body() != null) {
                    try {
                        InternalStorageService.writeCacheToFile(getContext(), TAG_WITHDRAW_MONEY, response.body());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else {
